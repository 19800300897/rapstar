...
Component({
  externalClasses: ['gov-textarea-title', 'gov-textarea-wrap', 'gov-textarea-element', 'gov-notice-icon'],
  properties: {
    // 头部标题
    head: {
      type: String,
  ...
  methods: {
    ...
    showNotic: function showNotic() {
      var _this$data$noticeInfo = this.data.noticeInfo,
          type = _this$data$noticeInfo.type,
          modalOptions = _this$data$noticeInfo.modalOptions,
          toastOptions = _this$data$noticeInfo.toastOptions;
    ...
    handleInput: function handleInput(_ref2) {
      ...
      var len = this.data.maxlength - detail.cursor;
      var words = Math.abs(len) > 999 ? '999+' : Math.abs(len);
